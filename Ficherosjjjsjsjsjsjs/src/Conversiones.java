...
//			en el array de string en esta linea en el orden que nos interese
			listaAeropuertos.add(new String(temporalLinea[3], temporalLinea[4], temporalLinea[1], temporalLinea[2]));
		}
...
//	que necesitemos extraidos de la lista de objetos anteriormente creada
	public static List<String> obtenerListaStrings(List<String> listaAeropuertos){
