public class ApoyoAeropuerto implements Comparable<ApoyoAeropuerto>{
	...
	public ApoyoAeropuerto(String codAeropuertoIATA, String codAeropuertoICAO, String nombre, String pais) {
		super();
	...
	@Override
	public int compareTo(ApoyoAeropuerto dos) {
